package org.redbrick.medright.tracker.domain;
...
import org.redbrick.medright.tracker.utils.TType;
 ...
 */
/**
 * This class provides the foundation for all other operartion's. Providing
 * persistence to this class will allow each instance of this class to either
 * insert into the scheduleDB database a row or to update/delete an existing row
...
public class Treatment {
	...
	/**
	 * Indicates that the treatment is only taken as needed and not according to
	 * a particular schedule
	 */
	private boolean AsNeeded;

	/**
	 * Indicates the number of minutes ahead of the next naturally occurring
	...
	/**
	 * Indicates that the treatment is to be taken at the time set for an am
	 * schedule
	 */
	private boolean am;

	/**
	 * Indicates that the treatment is to be taken at the time set for a bedtime
	 * schedule
	 */
	...
	/**
	 * Declares the type of measure used in indicating the dose above: i.e.
	 * milligrams, cc's, etc..
	 */
	...
	/**
	 * Declares the name of the treatment as indicated on the container for the
	 * treatment
	 */
	private String name;

	/**
	 * Indicates that the treatment is to be taken at the time set for a noon
	 * schedule
	 */
	private boolean noon;

	/**
	 * Declares time-frames other than the above listed times: i.e. monthly,
	...
	/**
	 * Declares the type of treatment: i.e. Pill, Liquid, Topical, Injection or
	 * Supplement.
	 * 
	 * TType is an enumerated datatype containing the five possibilities for the
	 * field 'type'
	 * 
	 * In reality this is not actually needed because the ui that is used for
	 * setting the instance's 'type' field is fixed to the available values in a
	 * combo box. However, making 'type' an enumerated data type provides a
	 * "warm fuzzy" in ensuring that the value of that field can only be one of
	...
	/**
	 * Defines a unique identifying number for each treatment entry based upon
	 * type of treatment.
	 */
	private int uuid;
	...
	/**
	 * Surrogate variable used to provide an empty constructor for persistence.
	 */
	@SuppressWarnings("unused")
