 ...
 * the next one in line to the EventTimeSync as and hour and minute argument
 * set.
 *
 * @author RedBrick
 */
public class EventTracker {
	...
	public static void nextEvent() throws InterruptedException {
		 ...
		 * to the startSync method in the EventTimeSync class. Then we can pass
		 * arguments to the EventTimeSync() method.
		 */
		EventTimeSync ets = new EventTimeSync();
		byte eh = 0;
		byte em = 0;
		boolean status = ets.startSync(eh, em);
